...
if __name__ == "__main__":
    ...
    J = np.loadtxt("Jac_1PB7_160_0.txt")
    f_target = np.loadtxt("fparams_1PB7_160_0.txt") 
    f_sim = np.loadtxt("sparams_1PB7_160_0.txt") 
    ...
    size_perturb = []
    Xps = []
    print "The Shape of Gamma is: " + str(np.shape(Gammas))
    count = 0
    for gamma in Gammas:
        ...
        Xps.append(x_soln)
        print "Went through " + str(count) + " iterations."
        count += 1
